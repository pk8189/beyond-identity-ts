...
describe("tests client.v1.tenants.realms.resourceServers.roles.deleteScopes.create", () => {
  test.concurrent("200 generated_success_unassign_scopes", async () => {
    // Generated success test for Unassign Scopes body example from OpenAPI
