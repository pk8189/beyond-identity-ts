...
import * as requests from "@public/beyond_identity_api/resources/v1/tenants/realms/groups/delete-members/request-types";
...
export class DeleteMembersClient extends CoreResourceClient {
  ...
  create(
    ...
    return this._client.makeRequest({
      method: "post",
      path: `/v1/tenants/${request.tenantId}/realms/${request.realmId}/groups/${request.groupId}:deleteMembers`,
      auth: ["BearerAuth"],
