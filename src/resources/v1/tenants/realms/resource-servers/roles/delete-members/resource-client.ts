...
import * as requests from "@public/beyond_identity_api/resources/v1/tenants/realms/resource-servers/roles/delete-members/request-types";
import * as types from "@public/beyond_identity_api/types";

export class DeleteMembersClient extends CoreResourceClient {
  ...
  create(
    ...
    return this._client.makeRequest({
      method: "post",
      path: `/v1/tenants/${request.tenantId}/realms/${request.realmId}/resource-servers/${request.resourceServerId}/roles/${request.roleId}:deleteMembers`,
      auth: ["BearerAuth"],
