...
import * as requests from "@public/beyond_identity_api/resources/v1/tenants/realms/resource-servers/roles/list-scopes/request-types";
import * as types from "@public/beyond_identity_api/types";
import qs from "qs";

export class ListScopesClient extends CoreResourceClient {
  ...
  list(
    ...
    opts?: RequestOptions,
  ): ApiPromise<types.ListRoleScopesResponse> {
    // send request (keep comment for code generation)
    return this._client.makeRequest({
      method: "get",
      path: `/v1/tenants/${request.tenantId}/realms/${request.realmId}/resource-servers/${request.resourceServerId}/roles/${request.roleId}:listScopes`,
      auth: ["BearerAuth"],
      query: [
